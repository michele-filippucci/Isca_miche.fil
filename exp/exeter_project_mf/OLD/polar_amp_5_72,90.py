...
exp = Experiment('exeter_project_mf_aa_5_72,90', codebase=cb)
#Add any input files that are necessary for a particular experiment.
exp.inputfiles = [os.path.join(base_dir,'input/ocean_qflux_anom_5_72,90.nc')]
...
exp.namelist = namelist = Namelist({
	...
	'do_qflux':False,
	'load_qflux':True,
	'qflux_file_name':'ocean_qflux_anom_5_72,90',             
    },
...
if __name__=="__main__":
    exp.run(1, use_restart = '$GFDL_DATA/exeter_project_mf_baseline_ml2.5/restarts/res0036.tar.gz', num_cores=NCORES)
