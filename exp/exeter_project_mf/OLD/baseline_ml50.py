...
exp = Experiment('exeter_project_mf_baseline_ml50', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'mixed_layer_nml': {
        ...
        'evaporation':True,   
        'depth': 50.0,                          #Depth of mixed layer used
...
if __name__=="__main__":
    exp.run(108, use_restart = '$GFDL_DATA/exeter_project_mf_baseline_ml50/restarts/res0107.tar.gz', num_cores=NCORES)
