...
exp = Experiment('exeter_project_mf_baseline_ml5', codebase=cb)
...
if __name__=="__main__":
    #exp.run(109, use_restart = '$GFDL_DATA/exeter_project_mf_baseline_ml5/restarts/res0108.tar.gz', num_cores=NCORES)
