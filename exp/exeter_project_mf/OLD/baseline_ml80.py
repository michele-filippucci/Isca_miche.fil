...
exp = Experiment('exeter_project_mf_baseline_ml80', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'mixed_layer_nml': {
        ...
        'evaporation':True,   
        'depth': 80.0,                          #Depth of mixed layer used
...
if __name__=="__main__":
    exp.run(109, use_restart = '$GFDL_DATA/exeter_project_mf_baseline_ml80/restarts/res0108.tar.gz', num_cores=NCORES)
