...
exp = Experiment('exeter_project_mf_baseline', codebase=cb)
...
if __name__=="__main__":
    exp.run(25, use_restart='$GFDL_DATA/exeter_project_mf_baseline/restarts/res0024.tar.gz', num_cores=NCORES)
