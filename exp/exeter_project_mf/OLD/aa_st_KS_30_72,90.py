...
exp = Experiment('aa_st_KS_30_72,90', codebase=cb)
...
diag.add_field('mixed_layer', 'flux_oceanq', time_avg=True, files=['atmos_monthly']) #latent heat flux
...
if __name__=="__main__":
    ...
    exp.run(84, use_restart='$GFDL_DATA/aa_st_KS_30_72,90/restarts/res0083.tar.gz', num_cores=NCORES, overwrite_data=False)
    #exp.run(1, use_restart=False, num_cores=NCORES, overwrite_data=False)
    for i in range(85,121): # run for 10 years
