...
exp = Experiment('exeter_project_mf_baseline_ml20', codebase=cb)
...
if __name__=="__main__":
    ...
    exp.run(47, use_restart='$GFDL_DATA/exeter_project_mf_baseline_ml20/restarts/res0046.tar.gz',num_cores=NCORES)
