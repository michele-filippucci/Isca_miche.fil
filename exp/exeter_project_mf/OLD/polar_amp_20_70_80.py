...
exp = Experiment('exeter_project_mf_aa', codebase=cb)
#Add any input files that are necessary for a particular experiment.
exp.inputfiles = [os.path.join(base_dir,'input/ocean_qflux_anom.nc')]
...
exp.namelist = namelist = Namelist({
	...
	'do_qflux':True,
	'load_qflux':True,
	'qflux_file_name':'ocean_qflux_anom',             
    },
...
if __name__=="__main__":
    exp.run(89, use_restart = '$GFDL_DATA/exeter_project_mf_baseline_ml50/restarts/res0088.tar.gz', num_cores=NCORES)
