...
exp = Experiment('exeter_project_mf_baseline_KS_qflux100', codebase=cb)
...
if __name__=="__main__":
    ...
    exp.run(23, use_restart='/home/links/mf671/DATA/isca_data/exeter_project_mf_baseline_KS_qflux100/restarts/res0022.tar.gz', num_cores=NCORES, overwrite_data=True)
