...
exp = Experiment('exeter_project_mf_aa_KS_30_72,90', codebase=cb)
...
if __name__=="__main__":
    ...
    exp.run(385, use_restart='$GFDL_DATA/exeter_project_mf_aa_KS_30_72,90/restarts/res0384.tar.gz', num_cores=NCORES, overwrite_data=True)
